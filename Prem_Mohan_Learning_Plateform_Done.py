...
def send_otp_email(receiver_email):
    ...
    msg = MIMEMultipart()
    msg['From'] = "otimepass57@gmail.com"
    msg['To'] = receiver_email
    msg['Subject'] = "OTP Verification"
    msg.attach(MIMEText(f" Dear user, Your OTP is access NextGen Learning Platform : {otp}. It will be valid for 5 minutes", 'plain'))

    try:
        server = smtplib.SMTP('smtp.gmail.com', 587)
        server.starttls()
        server.login("otimepass57@gmail.com", "ukoqwazrajcwaeut")
...
def dashboard():
    ...
    try:
        ...
        if user:
            ...
            st.markdown(f"""
    <h1 style='font-family: "Times New Roman", Times, serif; color: #2c3e50;'>
